...
class MockBookApi : BookApi {
    ...
    override fun libraryPortalAsync(): Deferred<ApiResponse<LibraryBean>> {
        return GlobalScope.async {
            ApiResponse<LibraryBean>(1,
                    "操作成功",

                   LibraryBean(listOf(
                           CarouseItem("https://res1.xiaoqinre.com/images/cover/201807/1530537387O-NvKf3ZohGRjv6E.jpg", 1, 0, "001", "标题1"),
                           CarouseItem("https://res1.xiaoqinre.com/images/cover/201802/1519006021WbTCmS0j8HZbGmCl.jpg", 1, 0, "002", "标题2"),
                           CarouseItem("https://res1.xiaoqinre.com/images/cover/202012/1607591222jS3RgD6h6EjARjuz.jpg", 1, 0, "003", "标题3"),
                           CarouseItem("https://res1.xiaoqinre.com/images/cover/202012/1607337790f6oI732I6aVyI416.jpg", 1, 0, "004", "标题4")
                   ),
                           ...
                           listOf(BlockItem("恐怖靈異", listOf(BlockBookItem("0288828", "https://res1.xiaoqinre.com/images/cover/201807/1530537387O-NvKf3ZohGRjv6E.jpg",  "书桌名要"),
                                   ...
                                   BlockItem("科幻小說", listOf( BlockBookItem("0288828", "https://res1.xiaoqinre.com/images/cover/202012/1607930027BuZAoVwSA4N7f8iR.jpg",  "特搜组大吾 救国的橘色部队"),
                                           ...
                                           BlockBookItem("0288828", "https://res1.xiaoqinre.com/images/cover/202012/1607337790f6oI732I6aVyI416.jpg",  "悠米的玩偶"),
                                           BlockBookItem("0288828", "https://res1.xiaoqinre.com/images/cover/202012/1607591222jS3RgD6h6EjARjuz.jpg",  "纸箱战机"))),
                                   BlockItem("玄幻魔法", listOf(BlockBookItem("0288828", "https://res1.xiaoqinre.com/images/cover/201807/1530537387O-NvKf3ZohGRjv6E.jpg",  "书桌名要"),
    ...
    override fun bookChapterAsync(bookId: String, chapterId: String): Deferred<ApiResponse<ChapterItemBean>> {
        return GlobalScope.async {
            ApiResponse<ChapterItemBean>(1,
                    "操作成功",
    ...
    override fun bookChapterAsync2(url: String): Deferred<ChapterItemBean> {
        return GlobalScope.async {
            ChapterItemBean(
                    "test_1234",
                    url,
                    "book chapter test content"
            )
        }
    }
